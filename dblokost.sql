...
--
-- Host: localhost:3306
-- Generation Time: May 05, 2026 at 12:00 AM
...
--
-- Triggers `stok_barang`
--
DELIMITER $$
CREATE TRIGGER `trg_cek_stok_sebelum_update` BEFORE UPDATE ON `stok_barang` FOR EACH ROW BEGIN
    IF NEW.jumlah < 0 THEN
        SIGNAL SQLSTATE '45000'
        SET MESSAGE_TEXT = 'Stok tidak boleh minus!';
    END IF;
END
$$
DELIMITER ;
